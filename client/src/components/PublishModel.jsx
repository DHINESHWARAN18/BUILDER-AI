...
const PublishModel = ({publishUrl , onClose}) => {
  ...
  return (
    <div className='absolute inset-0 bg-zinc-950/40 backdrop-blur-xs
    flex items-center justify-center z-50'>
        <div className='bg-white border border-zinc-200 shadow-lg
        rounded-xl max-w-md w-full p-6 mx-4 relative'>
            ...
            <div className='space-y-4'>
                <div>
                    ...
                    className='w-full px-0 py-2 border-b border-zinc-200 text-sm
                    text-zinc-900 bg-transparent outline-none' />
                </div>
                <div className='flex gap-2 pt-2'>
                    <button onClick={handleCopyLink} className='flex-1 py-2 bg-zinc-950 text-white
                    text-xs font-medium hover:bg-zinc-800 cursor-pointer
