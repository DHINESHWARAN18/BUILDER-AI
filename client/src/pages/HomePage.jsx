          ...
          <div className='masked-marquee w-full mt-4 max-w-2xl overflow-hidden py-1'>
            <div className='animate-marquee gap-3'>
                {homeTags.map((tag,i)=>(
                  ...
                  className='px-4 py-1.5 border rounded-full text-sm text-white
                  bg-white/10 border-white/25 hover:bg-white/20 transition
                  cursor-pointer shrink-0 font-medium'>
                    {tag}
                  </button>
                ))}
            </div>
          ...
          {!loadingProjects && projects.length > 0 && (
            <div className='mt-12 w-full'>
              ...
              <div className='flex items-center justify-between pb-3 mb-3 border-b border-white/10'>
                <p className='text-xs font-medium uppercase text-zinc-100 tracking-widset'>All projects</p>
              ...
              <div className='space-y-2 max-h-[80vh] overflow-y-auto pr-1'>
                {projects.map((p)=>(
                  <div key={p._id} className='bg-white/5 border border-white/10
                  rounded-lg px-4 py-3 flex items-center justify-between group hover:border-white/20
