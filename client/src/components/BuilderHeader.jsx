  ...
  return (
    ...
    border-zinc-200 bg-white'>
        <div className='flex items-center gap-2'>
            <button onClick={onBack} className='p-1.5 rounded-md text-zinc-400
            hover:text-zinc-950 hover:bg-zinc-100 cursor-pointer'>
            ...
            <span className='text-[10px] px-1.5 py-0.5 rounded bg-zinc-100
            text-zinc-500 font-medium'>v{version}</span>
        </div>

        <div className='flex items-center gap-1.5'>
            <button onClick={onToggleShowCode}
            className={`inline-flex items-center justify-center gap-1.5 py-1.5
            px-3 border border-zinc-200 text-zinc-600 hover:bg-zinc-100
            hover:text-zinc-900 text-xs font-medium rounded-lg
            cursor-pointer bg-white ${showCode ? "bg-zinc-100 text-zinc-900" : ""}`}>
                {showCode ? (
                    <>
                    <EyeIcon size={13} />
                    preview
            ...
            <button onClick={onOpenPreview} className='inline-flex items-center justify-center gap-1.5 py-1.5
            px-3 border border-zinc-200 text-zinc-600 hover:bg-zinc-100
            hover:text-zinc-900 text-xs font-medium rounded-lg
