...
const ChatPanel = ({messages , onSend,loading}) => {
  ...
  return (
    <div className='flex flex-col h-full bg-white'>
        ...
        hide-scrollbar'>
            {messages.length === 0 && (
                <div className='flex items-center justify-center h-full'>
                    ...
                    >Ask AI to modify your website</p>
                ...
                <div key={i}>
                    <div className='flex gap-2.5 items-start'>
                        ...
                        <div className='flex-1 min-w-0'>
                            ...
                            uppercse tracking-wider'>
                                {msg.role === "user" ? "You" : "AI"}
                            </p>
                            <p className='text-[13px] text-zinc-700 leading- trancking-wider
            ...
            {loading && (
                <div className='flex gap-2.5 items-start'>
                    <div className='shrink-0 w-6 rounded-md felx items-center
                    justify-center mt-0.5 bg-zinc-900/5'>
                        <BotIcon size={13} className='text-zinc-900' />
                    </div>
                    <div className='flex-1'>
                        <p className='text-[11px] font-medium text-zinc-400
                        mb-2 uppercase tracking-wider'>AI</p>
        ...
        {/* input */}
        <div>
            <PromptInput onsubmit={onSend} loading={loading} placeholder='Ask AI to modiify...' autoFocus/>
        </div>
